...
export default function DetailsEditor() {
    ...
    const handleSaveQuiz = async (courseId: string) => {
        ...
        let createdOrUpdatedQuiz;
        if (qid) {
          await quizClient.updateQuiz(qid, updatedQuiz);
          createdOrUpdatedQuiz = { ...updatedQuiz, _id: qid };
        } else {
          createdOrUpdatedQuiz = await quizClient.createQuiz(courseId, updatedQuiz);
        }
      
        if (createdOrUpdatedQuiz.published) {
          navigate(`/Kanbas/Courses/${courseId}/Quizzes`);
        } else {
          navigate(`/Kanbas/Courses/${courseId}/Quizzes/${createdOrUpdatedQuiz._id}/edit`);
        }
      };
